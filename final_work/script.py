...
def success():  
    if request.method == 'POST':
        ...
        return render_template("success.html", imagelist=IMG_LIST,name = f.filename,name2=f2.filename) 
    else:  
        abort(415)
# file upload end       
...
def output():
    ...
    resp = make_response(render_template("output.html", imagelist=Flask_Logo ))
    return resp
